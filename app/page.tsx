...
const roles = [
  {
    ...
    children: [
      ...
      { href: "/newcomer/timeline", label: "12-month timeline", sub: "All phases, all dimensions" },
      { href: "/newcomer/progress", label: "Progress charts", sub: "Scores over time · divergence" },
      { href: "/newcomer/buckets", label: "My Journey", sub: "FIT · ACE · TIE progress" },
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/manager/checkin/sofia", label: "Manager check-in", sub: "Rate newcomer's FIT · ACE · TIE" },
